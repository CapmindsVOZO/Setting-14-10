...
//	public static void main(String[] args) throws InterruptedException {
	...
	public void Login() throws InterruptedException {
		...
		sendkeys(pom.getSettings().getUsername(), "Admin3");

		// Enter Password

		sendkeys(pom.getSettings().getPassword(), "Admin@123");

		// Click Signin Button '

		Clickonelement(pom.getSettings().getSigninbtn());
...
//			e.printStackTrace();
	...
	public void BILLINGANDSERVICES() throws InterruptedException {
		...
		WebElement clinical1 = wait4.until(ExpectedConditions.elementToBeClickable(
				By.xpath("(//div[@class='schedule-title m-t-10 f-s-16 for-set-nav-arrow3'])[1]")));
...
//	
	...
	public void Senderx() throws InterruptedException {
		...
		WebElement clinical42 = wait62
				.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[contains(text(),'Administration')]")));
